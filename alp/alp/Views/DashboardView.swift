...
struct DashboardView: View {
    ...
    private func operationalMenuSection(event: Event) -> some View {
        VStack(spacing: 12) {
            HStack(spacing: 6) {
            ...
            HStack(spacing: 12) {
                NavigationLink {
                    ...
                    menuButton(icon: "person.3.fill", label: "Divisions", color: .blue)
                }
                .buttonStyle(.plain)
                ...
                NavigationLink {
                    ...
                    menuButton(icon: "list.bullet.rectangle.portrait.fill", label: "Members", color: .green)
                }
                .buttonStyle(.plain)
